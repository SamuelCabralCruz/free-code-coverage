...
aws s3 cp coverage-metric-failure-main.txt s3://free-code-coverage/coverage-metric-failure-embedded-main.txt
aws s3 cp coverage-metric-success-main.txt s3://free-code-coverage/coverage-metric-success-main.txt
aws s3 cp coverage-metric-success-main.txt s3://free-code-coverage/coverage-metric-success-embedded-main.txt
